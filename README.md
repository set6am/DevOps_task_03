...
Напиши bash-скрипт. За основу возьми скрипт из Задания 2 и убери из него часть, ответственную за сохранение данных в файл.
...
Напиши bash-скрипт. За основу возьми скрипт из Задания 3. Обозначения цветов аналогичные.  
